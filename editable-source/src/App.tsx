...
const legacyProjects: Project[] = [
  ...
  { id: 'smart-home', title: 'Smart Home', type: 'Software & IoT', categories: ['software'], image: new URL('./assets/projects/smart-home.png', import.meta.url).href, tags: ['Android', 'IoT', 'Firebase'], summary: 'An Android and IoT project exploring how connected devices can make everyday actions simpler.', impact: 'End-to-end prototype', date: '2020', why: 'The project explores the bridge between a physical environment and a software interface.', approach: 'Combine an Android interface with connected device logic and Firebase-backed state.', tradeoffs: 'A small, understandable system is more valuable for a prototype than a broad feature list that is difficult to test.', result: 'A hands-on experiment in product thinking, device interaction and software structure.' },
  { id: 'flower-trade', title: 'Flower Trade', type: 'Software', categories: ['software'], image: new URL('./assets/projects/flower-trade.png', import.meta.url).href, tags: ['HTML', 'CSS', 'JavaScript'], summary: 'A website development project focused on presenting a catalogue and trade workflow clearly.', impact: 'Responsive web build', date: '2020', why: 'A catalogue-led business needs a clear path from browsing to action.', approach: 'Structure the interface around product discovery, readable information and responsive layouts.', tradeoffs: 'The visual system stays simple so content remains the hero and the site is easy to maintain.', result: 'A complete front-end site demonstrating practical web development and interface structure.' },
  { id: 'time-series', title: 'Time Series Forecasting', type: 'Data science', categories: ['data', 'analytics'], image: new URL('./assets/projects/time-series.png', import.meta.url).href, tags: ['Python', 'Modelling', 'Visualization'], summary: 'A practical forecasting project exploring patterns over time and model evaluation.', impact: 'Model-led analysis', date: '2020', why: 'Forecasts are only useful when their assumptions and limitations are visible.', approach: 'Explore time-based patterns, build candidate models and evaluate them against held-out observations.', tradeoffs: 'Interpretability and evaluation discipline matter as much as model complexity.', result: 'A structured approach to turning historical patterns into useful planning signals.' },
  { id: 'data-science-a1', title: 'Practical Data Science A1', type: 'Data science', categories: ['data'], image: new URL('./assets/projects/data-science-a1.png', import.meta.url).href, tags: ['Python', 'Statistics', 'EDA'], summary: 'Exploratory analysis and modelling exercises that build a strong data science foundation.', impact: 'Foundational analysis', date: '2020', why: 'Good analysis starts with understanding the shape, quality and meaning of the data.', approach: 'Combine exploratory analysis, statistical reasoning and visual communication.', tradeoffs: 'The work favours explainable steps that can be checked and repeated.', result: 'A set of practical foundations for later modelling and production analytics.' },
  { id: 'data-science-a2', title: 'Practical Data Science A2', type: 'Data science', categories: ['data'], image: new URL('./assets/projects/data-science-a2.png', import.meta.url).href, tags: ['Python', 'Modelling', 'Evaluation'], summary: 'A second practical study in analysis, visualization and model evaluation.', impact: 'Applied modelling', date: '2020', why: 'A model should earn trust by making its evaluation and limitations clear.', approach: 'Prepare the data, compare approaches and communicate what the results mean in context.', tradeoffs: 'A transparent model with clear evaluation is preferable to unexplained complexity.', result: 'An applied project connecting statistical thinking with real-world interpretation.' },
  { id: 'advanced-java', title: 'Advanced Java', type: 'Software', categories: ['software'], image: new URL('./assets/projects/advanced-java.png', import.meta.url).href, tags: ['Java', 'OOP', 'Applications'], summary: 'An application-focused project exploring Java structure, logic and reusable components.', impact: 'Object-oriented build', date: '2019', why: 'Software quality depends on making behaviour understandable and changeable.', approach: 'Use object-oriented structure and reusable components to separate concerns.', tradeoffs: 'Good structure adds a little ceremony but keeps future changes safer.', result: 'A practical demonstration of Java application development fundamentals.' },
  { id: 'ancient-games', title: 'Ancient Games', type: 'Software & mobile', categories: ['software'], image: new URL('./assets/projects/ancient-games.png', import.meta.url).href, tags: ['Android', 'Firebase', 'Mobile'], summary: 'A mobile project bringing classic games into an accessible digital experience.', impact: 'Mobile experience', date: '2019', why: 'Small games are a useful way to practise interaction design, state and feedback.', approach: 'Build a mobile interface around clear game states and a simple, responsive experience.', tradeoffs: 'Keep the interaction focused so the experience feels immediate on a small screen.', result: 'A mobile prototype combining interface design and application logic.' }
];
...
function ProjectMedia({ project, detail = false }: { project: Project; detail?: boolean }) {
  if (project.image) {
    const image = <img src={project.image} alt={`${project.title} preview`} loading={detail ? 'eager' : 'lazy'} />;
    return <div className={`project-image ${detail ? 'project-image-detail' : ''}`}>{detail ? <a className="project-image-link" href={project.image} target="_blank" rel="noreferrer" title="Open image at full size">{image}</a> : image}<span className="project-badge">{project.type}</span></div>;
  }
