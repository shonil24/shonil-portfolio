...
function Router() {
  return <Switch><Route path="/" component={Home} /><Route path="/projects" component={Projects} /><Route path="/projects/:id">{(params) => <ProjectDetail id={params.id} />}</Route><Route path="/experience" component={Experience} /><Route path="/thinking" component={Thinking} /><Route path="/notes/:id">{(params) => <BlogPost id={params.id} />}</Route><Route path="/notes" component={Notes} /><Route component={NotFound} /></Switch>;
}

const queryClient = new QueryClient();

function App() {
  return <QueryClientProvider client={queryClient}><TooltipProvider><SiteShell><ErrorBoundary><Router /></ErrorBoundary></SiteShell><Toaster /></TooltipProvider></QueryClientProvider>;
}
